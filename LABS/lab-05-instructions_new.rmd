...
A new format is available for the R Markdown template that organizes all of the instruction’s code and a template for answering each question, found [**here**](https://drive.google.com/open?id=10Dvt5Sh46yFVtm4LGCGhUvLO5Inx8Lyl).

If you’d prefer the original R Markdown template, you can download that old file [**here**](https://cdn.rawgit.com/DS4PS/Data-Science-Class/c464d527/TEMPLATES/MarkdownTemplateSimple.Rmd).
...
After you have completed your lab, knit your RMD file. Login to iCollege and navigate to the assignments tab in the course repository. Upload your RMD and your HTML files to the Lab 05 submission link.
